...
## 💻 Features
* **Core Arithmetic Logic:** Handles addition, subtraction, multiplication, and division seamlessly.
* **Optimal Event Handling:** Utilizes JavaScript Event Delegation on the parent container instead of individual button listeners for better memory performance.
* **State Management:** Efficiently tracks continuous operations, resets, and current display states using modular JS functions.
...
---
*Developed by Sahil Vishwakarma*
